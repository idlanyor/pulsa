...
class Product {
    ...
    public function create($data) {
        ...
        $required_fields = ['provider_id', 'category_id', 'name', 'code', 'quota', 'buy_price', 'sell_price'];
        ...
        try {
            ...
            $this->db->bind(':validity_days', !empty($data['validity_days']) ? $data['validity_days'] : null);
            ...
            if (!$this->db->execute()) {
                throw new Exception("Failed to initialize stock");
            }
