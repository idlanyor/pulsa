...
<body>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($products as $product): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($product['buy_price']) ?></td>
                                                <td><?= htmlspecialchars($product['sell_price']) ?></td>
                                                <td><?= htmlspecialchars($product['status']) ?></td>
                                                <td>
                                                    <button class="btn btn-sm btn-warning" onclick="openEditProductModal(<?= htmlspecialchars($product['id']) ?>)">Edit</button>
                                                    <button class="btn btn-sm btn-danger" onclick="openDeleteModal(<?= htmlspecialchars($product['id']) ?>)">Hapus</button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
    ...
    <div id="productModal" class="modal">
        <div class="modal-content">
            ...
            <h2><span id="modalTitle">Tambah Produk Baru</span></h2>
            <form method="POST">
                ...
                <button type="submit" name="add_product" id="addProductBtn" class="btn btn-primary">Tambah</button>
                <button type="submit" name="edit_product" id="editProductBtn" class="btn btn-primary" style="display:none;">Simpan Perubahan</button>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function openEditProductModal(id) {
            ...
            // Populate form with existing product data (you'll need to fetch this from your API)
